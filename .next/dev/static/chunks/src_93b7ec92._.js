...
"[project]/src/app/accounting/project-costs/[id]/page.jsx [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/node_modules/next/dist/compiled/react/index.js [app-client] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$components$2f$Sidebar$2e$jsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/src/components/Sidebar.jsx [app-client] (ecmascript)"); // ถอย 4 ชั้น
...
function ProjectCostDetail() {
    ...
    if ($[0] !== "af55d65f6752d410bd8d9fff3488a7130e8d9b5f879228a83afd4febf436127e") {
        for(let $i = 0; $i < 101; $i += 1){
            $[$i] = Symbol.for("react.memo_cache_sentinel");
        }
        $[0] = "af55d65f6752d410bd8d9fff3488a7130e8d9b5f879228a83afd4febf436127e";
    }
    ...
    if ($[1] !== id) {
        t0 = ({
            "ProjectCostDetail[useEffect()]": ()=>{
                fetch(`/api/production/projects/${id}`).then(_ProjectCostDetailUseEffectAnonymous).then({
                    "ProjectCostDetail[useEffect() > (anonymous)()]": (res_0)=>{
                        setData(res_0);
                        setLoading(false);
                    }
                }["ProjectCostDetail[useEffect() > (anonymous)()]"]).catch(_ProjectCostDetailUseEffectAnonymous2);
            }
        })["ProjectCostDetail[useEffect()]"];
        t1 = [
            id
    ...
    if (loading) {
        ...
        if ($[4] === Symbol.for("react.memo_cache_sentinel")) {
            t2 = /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                ...
                fileName: "[project]/src/app/accounting/project-costs/[id]/page.jsx",
                lineNumber: 47,
                columnNumber: 12
            }, this);
            $[4] = t2;
    ...
    let t8;
    let t9;
    if ($[6] !== costs || $[7] !== project.customer_name || $[8] !== project.due_date || $[9] !== project.project_name || $[10] !== project.sale_price || $[11] !== project.status) {
        const totalCost = costs.reduce(_ProjectCostDetailCostsReduce, 0);
        const revenue = parseFloat(project.sale_price || 0);
        const profit = revenue - totalCost;
        const profitMargin = revenue > 0 ? profit / revenue * 100 : 0;
        const isLoss = profit < 0;
        t13 = "flex min-h-screen bg-slate-50 font-sans";
        ...
        t10 = "flex-1 ml-64 p-8 w-[calc(100%-16rem)]";
        if ($[26] === Symbol.for("react.memo_cache_sentinel")) {
            t11 = /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$client$2f$app$2d$dir$2f$link$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"], {
                href: "/accounting/project-costs",
                className: "flex items-center gap-2 text-slate-500 hover:text-blue-600 mb-6 transition w-fit group",
                children: [
        ...
        const t16 = `px-2.5 py-0.5 rounded-full text-xs font-bold border uppercase ${project.status === "completed" ? "bg-green-100 text-green-700 border-green-200" : "bg-blue-100 text-blue-700 border-blue-200"}`;
        let t17;
        if ($[29] !== project.status || $[30] !== t16) {
        ...
        const t20 = project.customer_name || "-";
        let t21;
        let t22;
        ...
        let t23;
        if ($[38] !== project.due_date) {
            t23 = project.due_date ? new Date(project.due_date).toLocaleDateString("th-TH") : "-";
            $[38] = project.due_date;
            $[39] = t23;
        } else {
            t23 = $[39];
        ...
        if ($[51] === Symbol.for("react.memo_cache_sentinel")) {
            t29 = /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                className: "w-px bg-slate-200 h-10"
            }, void 0, false, {
                fileName: "[project]/src/app/accounting/project-costs/[id]/page.jsx",
                lineNumber: 198,
                columnNumber: 13
        ...
        const t31 = `text-xl font-bold ${isLoss ? "text-red-500" : "text-green-600"}`;
        let t32;
        if ($[53] !== profit) {
            t32 = profit.toLocaleString();
            $[53] = profit;
            $[54] = t32;
        } else {
            t32 = $[54];
        ...
        const t34 = `text-[10px] ${isLoss ? "text-red-400" : "text-green-500"}`;
        const t35 = isLoss ? "\u0E02\u0E32\u0E14\u0E17\u0E38\u0E19" : "\u0E01\u0E33\u0E44\u0E23";
        let t36;
        if ($[58] !== profitMargin) {
            t36 = profitMargin.toFixed(1);
            $[58] = profitMargin;
            $[59] = t36;
        } else {
            t36 = $[59];
        ...
        if ($[70] !== t25 || $[71] !== t39) {
            t12 = /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                className: "bg-white p-6 rounded-2xl shadow-sm border border-slate-200 mb-6 flex flex-col md:flex-row justify-between items-start md:items-center gap-4",
                children: [
                    t25,
                    t39
                ]
        ...
        t9 = "bg-white rounded-2xl shadow-sm border border-slate-200 overflow-hidden";
        t7 = "p-6 border-b border-slate-100 flex justify-between items-center bg-slate-50/50";
        ...
        t5 = "text-sm font-bold text-slate-600";
        t6 = "\u0E23\u0E27\u0E21\u0E17\u0E31\u0E49\u0E07\u0E2A\u0E34\u0E49\u0E19: ";
        t2 = "text-red-600 text-lg ml-2";
        t3 = "-";
        t4 = totalCost.toLocaleString();
        $[6] = costs;
        $[7] = project.customer_name;
        $[8] = project.due_date;
        $[9] = project.project_name;
        $[10] = project.sale_price;
        $[11] = project.status;
        $[12] = t10;
        $[13] = t11;
        $[14] = t12;
    ...
    let t18;
    if ($[86] !== costs) {
        t18 = costs && costs.length > 0 ? /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
            className: "overflow-x-auto",
            children: /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("table", {
                className: "w-full text-sm text-left",
                children: [
                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("thead", {
                        className: "bg-white text-slate-500 font-bold border-b border-slate-100 text-xs uppercase",
                    ...
                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("tbody", {
                        ...
                        children: costs.map(_ProjectCostDetailCostsMap)
                    }, void 0, false, {
                        fileName: "[project]/src/app/accounting/project-costs/[id]/page.jsx",
                        lineNumber: 353,
                        columnNumber: 440
            ...
            children: [
                /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                    className: "bg-slate-100 p-4 rounded-full mb-3",
                    children: /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$lucide$2d$react$2f$dist$2f$esm$2f$icons$2f$receipt$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$export__default__as__Receipt$3e$__["Receipt"], {
                        size: 32,
                ...
                /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("p", {
                    children: "ยังไม่มีรายการค่าใช้จ่ายในโปรเจกต์นี้"
                }, void 0, false, {
                    fileName: "[project]/src/app/accounting/project-costs/[id]/page.jsx",
                    lineNumber: 353,
                    columnNumber: 730
    ...
    let t20;
    if ($[92] !== t10 || $[93] !== t11 || $[94] !== t12 || $[95] !== t19) {
...
_s(ProjectCostDetail, "tyaF42zRhhSEVzcW0Y5TlO6DA3c=", false, function() {
    return [
        __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$navigation$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useParams"]
    ];
});
_c = ProjectCostDetail;
function _ProjectCostDetailCostsMap(c, index) {
    return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("tr", {
        className: "hover:bg-slate-50 transition",
        children: [
            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("td", {
                className: "p-4 pl-6 text-slate-500 font-medium",
                children: [
                    ...
                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                        ...
                        children: new Date(c.created_at || c.recorded_date).toLocaleTimeString("th-TH", {
                            hour: "2-digit",
                            minute: "2-digit"
                        })
                    }, void 0, false, {
            ...
            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("td", {
                ...
                children: /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("span", {
                    className: "px-2 py-1 bg-slate-100 rounded text-xs text-slate-600 border border-slate-200 font-medium",
                    children: c.category === "material" ? "\u0E27\u0E31\u0E2A\u0E14\u0E38/\u0E2D\u0E38\u0E1B\u0E01\u0E23\u0E13\u0E4C" : c.category === "labor" ? "\u0E04\u0E48\u0E32\u0E41\u0E23\u0E07" : c.category === "subcontractor" ? "\u0E1C\u0E39\u0E49\u0E23\u0E31\u0E1A\u0E40\u0E2B\u0E21\u0E32" : "\u0E2D\u0E37\u0E48\u0E19\u0E46"
                }, void 0, false, {
                    fileName: "[project]/src/app/accounting/project-costs/[id]/page.jsx",
                    lineNumber: 400,
                    columnNumber: 212
            ...
            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("td", {
                className: "p-4 text-right font-bold text-red-600 tabular-nums",
                children: [
                    "-",
            ...
            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("td", {
                className: "p-4 text-center",
                children: c.slip_image ? /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("button", {
                    onClick: {
                        "ProjectCostDetail[costs.map() > <button>.onClick]": ()=>window.open(c.slip_image, "_blank")
                    }["ProjectCostDetail[costs.map() > <button>.onClick]"],
...
function _ProjectCostDetailCostsReduce(sum, item) {
    return sum + parseFloat(item.amount);
}
function _ProjectCostDetailUseEffectAnonymous2(err) {
    return console.error(err);
}
function _ProjectCostDetailUseEffectAnonymous(res) {
    return res.json();
}
var _c;
__turbopack_context__.k.register(_c, "ProjectCostDetail");
if (typeof globalThis.$RefreshHelpers$ === 'object' && globalThis.$RefreshHelpers !== null) {
    __turbopack_context__.k.registerExports(__turbopack_context__.m, globalThis.$RefreshHelpers$);
}
}),
...
//# sourceMappingURL=src_93b7ec92._.js.map