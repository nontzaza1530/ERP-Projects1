...
function ProductionPage() {
    ...
    const [activeMenu, setActiveMenu] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])(null); // เก็บ ID ของการ์ดที่เปิดเมนูอยู่
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
    ...
    const handleArchive = async (id, name)=>{
        ...
        if (result.isConfirmed) {
            try {
                ...
                const res_0 = await fetch(`/api/production/projects/${id}`, {
                    method: 'PUT',
                    headers: {
    ...
    const handleRestore = async (id_0, name_0)=>{
        ...
        if (result_0.isConfirmed) {
            try {
                ...
                const res_1 = await fetch(`/api/production/projects/${id_0}`, {
                    method: 'PUT',
                    headers: {
                        'Content-Type': 'application/json'
                    },
                ...
                if (res_1.ok) {
                    setProjects((prev_0)=>prev_0.map((p_0)=>p_0.id === id_0 ? {
                                ...p_0,
                                status: 'pending'
                            } : p_0));
    ...
    const handleDelete = async (id_1, name_1)=>{
        ...
        if (result_1.isConfirmed) {
            try {
                ...
                if (res_2.ok) {
                    // ลบออกจากหน้าจอ
                    setProjects((prev_1)=>prev_1.filter((p_1)=>p_1.id !== id_1));
    ...
    const getStatusBadge = (status)=>{
        ...
        return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("span", {
            className: `px-2.5 py-1 rounded-full text-xs font-bold ${styles[status] || styles.pending}`,
    ...
    // Logic การกรอง
    const filteredProjects = projects.filter((p_2)=>{
        if (filterStatus === 'archived') return p_2.status === 'archived';
        if (filterStatus === 'all') return p_2.status !== 'archived';
        return p_2.status === filterStatus;
    });
    return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                    ...
                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                        ...
                        children: [
                            ...
                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$client$2f$app$2d$dir$2f$link$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"], {
                                ...
                                children: /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("button", {
                                    className: "bg-orange-600 hover:bg-orange-700 text-white px-4 py-2.5 rounded-xl font-bold flex items-center gap-2 shadow-lg shadow-orange-200 transition",
                                    children: [
                                    ...
                                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$client$2f$app$2d$dir$2f$link$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"], {
                                        ...
                                        children: [
                                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("h3", {
                                                className: "font-bold text-lg text-slate-800 mb-1 group-hover:text-orange-600 transition",
...
_s(ProductionPage, "tScE5N0AZSk4M9j7AkexVQvaexw=");
_c = ProductionPage;
var _c;
