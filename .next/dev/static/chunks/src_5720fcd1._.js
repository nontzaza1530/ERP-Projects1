...
"[project]/src/app/production/page.jsx [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
function ProductionPage() {
    ...
    const handleArchive = async (id, name)=>{
        ...
        if (result.isConfirmed) {
            try {
                const res_0 = await fetch('/api/production/action', {
                    method: 'POST',
                    headers: {
                ...
                if (res_0.ok) {
                    ...
                    __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$sweetalert2$2f$dist$2f$sweetalert2$2e$all$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"].fire('เรียบร้อย!', 'ย้ายไปที่เก็บถาวรแล้ว', 'success');
                } else {
                    throw new Error('Update failed');
                }
            } catch (error_0) {
                __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$sweetalert2$2f$dist$2f$sweetalert2$2e$all$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"].fire('Error', 'ไม่สามารถบันทึกข้อมูลได้', 'error');
            }
        }
    };
    const handleRestore = async (id_0, name_0)=>{
        setActiveMenu(null);
        const result_0 = await __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$sweetalert2$2f$dist$2f$sweetalert2$2e$all$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"].fire({
            title: 'กู้คืนโครงการ?',
            text: `ดึง "${name_0}" กลับมาทำงานต่อใช่ไหม?`,
            icon: 'warning',
            showCancelButton: true,
        ...
        if (result_0.isConfirmed) {
            try {
                const res_1 = await fetch('/api/production/action', {
                    method: 'POST',
                    headers: {
                        'Content-Type': 'application/json'
                    },
                ...
                if (res_1.ok) {
                    ...
                    __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$sweetalert2$2f$dist$2f$sweetalert2$2e$all$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"].fire('สำเร็จ', 'กู้คืนโปรเจกต์แล้ว', 'success');
                } else {
                    throw new Error('Restore failed');
                }
            } catch (error_1) {
                __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$sweetalert2$2f$dist$2f$sweetalert2$2e$all$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"].fire('Error', 'ไม่สามารถกู้คืนได้', 'error');
            }
        }
    };
    const handleDelete = async (id_1, name_1)=>{
        setActiveMenu(null);
        const result_1 = await __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$sweetalert2$2f$dist$2f$sweetalert2$2e$all$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"].fire({
            ...
            text: `คุณต้องการลบ "${name_1}" ใช่หรือไม่? การกระทำนี้ไม่สามารถย้อนกลับได้`,
            icon: 'warning',
            showCancelButton: true,
        ...
        if (result_1.isConfirmed) {
            try {
                const res_2 = await fetch(`/api/production/projects/${id_1}`, {
                    method: 'DELETE'
                });
                if (res_2.ok) {
                    setProjects((prev_0)=>prev_0.filter((p_0)=>p_0.id !== id_1));
                    __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$sweetalert2$2f$dist$2f$sweetalert2$2e$all$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"].fire('ลบแล้ว!', 'โปรเจกต์ถูกลบออกจากระบบ', 'success');
                } else {
    ...
    const getStatusBadge = (status)=>{
        const styles = {
            ...
            // ปรับ completed เป็น done ให้ตรงกับ API ใหม่
        ...
        return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("span", {
            className: `px-2.5 py-1 rounded-full text-xs font-bold ${styles[normalizedStatus] || styles.pending}`,
            children: labels[normalizedStatus] || status
        }, void 0, false, {
            fileName: "[project]/src/app/production/page.jsx",
            lineNumber: 165,
            columnNumber: 12
        }, this);
    };
    // กรอง projects อย่างปลอดภัย (เช็คว่าเป็น array ก่อน)
    const filteredProjects = Array.isArray(projects) ? projects.filter((p_1)=>{
        if (filterStatus === 'archived') return p_1.status === 'archived';
        if (filterStatus === 'all') return p_1.status !== 'archived';
        // แปลง status ให้ตรงกัน (เช่น API ส่ง 'done' แต่ filter เราใช้ 'completed')
        if (filterStatus === 'completed' && p_1.status === 'done') return true;
        if (filterStatus === 'in_progress' && p_1.status === 'doing') return true;
        return p_1.status === filterStatus;
    }) : [];
    return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
            ...
            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("main", {
                ...
                children: /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                    ...
                    children: [
                        /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                            ...
                            children: [
                                        ...
                                        /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                            children: [
                                                ...
                                                /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("p", {
                                                    ...
                                                    children: "ติดตามสถานะและควบคุมต้นทุนการผลิต"
                                                }, void 0, false, {
                                                    fileName: "[project]/src/app/production/page.jsx",
                                                    lineNumber: 210,
                                                    columnNumber: 17
                                ...
                                /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$client$2f$app$2d$dir$2f$link$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"], {
                                    ...
                                    children: /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("button", {
                                        className: "bg-orange-600 hover:bg-orange-700 text-white px-4 py-2.5 rounded-xl font-bold flex items-center gap-2 shadow-lg shadow-orange-200 transition text-sm md:text-base",
                                        children: [
                        ...
                        /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                            className: "flex gap-2 mb-6 overflow-x-auto pb-2 border-b border-slate-200 custom-scrollbar",
                            children: [
                                'all',
                                'pending',
                                'in_progress',
                                ...
                                'archived'
                                    ...
                                    onClick: ()=>setFilterStatus(status_0),
                                    className: `px-4 py-2 rounded-t-lg text-sm font-bold border-b-2 transition whitespace-nowrap flex items-center gap-2
                  ${filterStatus === status_0 ? 'border-orange-600 text-orange-600 bg-orange-50' : 'border-transparent text-slate-500 hover:bg-slate-100 hover:text-slate-700'}`,
                                    children: [
                                        status_0 === 'archived' && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$lucide$2d$react$2f$dist$2f$esm$2f$icons$2f$file$2d$box$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$export__default__as__FileBox$3e$__["FileBox"], {
                                            size: 16
                                        }, void 0, false, {
                                            fileName: "[project]/src/app/production/page.jsx",
                                            lineNumber: 225,
                                        ...
                                        status_0 === 'all' ? 'ทั้งหมด' : status_0 === 'in_progress' ? 'กำลังผลิต' : status_0 === 'qc' ? 'รอ QC' : status_0 === 'completed' ? 'เสร็จแล้ว' : status_0 === 'archived' ? 'ที่เก็บถาวร' : 'รอเริ่ม'
                                    ]
                                }, status_0, true, {
                                    fileName: "[project]/src/app/production/page.jsx",
                                    lineNumber: 223,
                        ...
                        loading ? /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                            ...
                            children: [
                                ...
                                /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("p", {
                                    ...
                                    children: "ยังไม่มีรายการในสถานะนี้"
                                }, void 0, false, {
                                    fileName: "[project]/src/app/production/page.jsx",
                                    lineNumber: 233,
                                    columnNumber: 15
                          ...
                          ${project.status === 'archived' ? 'border-slate-200 opacity-75 grayscale-[0.5]' : 'border-slate-200 hover:shadow-md hover:border-orange-200'}`,
                                    children: [
                                                    ...
                                                    children: [
                                                        ...
                                                        /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                                            ...
                                                            children: [
                                                                ...
                                                                activeMenu === project.id && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Fragment"], {
                                                                    children: [
                                                                        /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                                                        ...
                                                                        /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                                                            className: "absolute right-0 top-8 w-40 bg-white rounded-xl shadow-xl border border-slate-100 z-20 overflow-hidden animate-in fade-in zoom-in duration-200",
                                                                            children: [
                                                                                project.status !== 'archived' ? /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("button", {
                                        ...
                                        /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$client$2f$app$2d$dir$2f$link$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"], {
                                            href: `/production/project/${project.id}`,
                                            className: "flex-1 flex flex-col",
                                            children: [
                                                /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("h3", {
                                                    className: "font-bold text-lg text-slate-800 mb-1 group-hover:text-orange-600 transition line-clamp-1",
                                                ...
                                                /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("p", {
                                                    className: "text-sm text-slate-500 mb-4 truncate",
                                                    children: project.customer_name || 'ไม่ระบุลูกค้า'
                                                }, void 0, false, {
                                                    fileName: "[project]/src/app/production/page.jsx",
                                                    lineNumber: 280,
                                                    columnNumber: 21
                                                ...
                                                /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                                    ...
                                                    children: [
                                                        ...
                                                        /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                                            className: "flex justify-between items-end border-t border-slate-100 pt-3",
                                                            children: [
                                                                /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                                                    children: [
                                                                        /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("p", {
                                                                            className: "text-[10px] text-slate-400 font-bold uppercase",
                                                                            children: "ต้นทุนใช้ไป"
                                                                        }, void 0, false, {
                                                                            fileName: "[project]/src/app/production/page.jsx",
                                                                            lineNumber: 290,
                                                                            columnNumber: 27
                                                                ...
                                                                /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                                                    ...
                                                                    children: [
                                                                        ...
                                                                        /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("p", {
                                                                            ...
                                                                            children: [
                                                                                "฿",
                                                                                parseFloat(project.sale_price || 0).toLocaleString()
                                                                            ]
                                                                        }, void 0, true, {
                                                                            fileName: "[project]/src/app/production/page.jsx",
                                                                            lineNumber: 295,
...
_s(ProductionPage, "ZsUD1g6KB/QN4qI7eDk6NjJcVfk=");
_c = ProductionPage;
var _c;
...
//# sourceMappingURL=src_5720fcd1._.js.map