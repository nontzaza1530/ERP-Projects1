...
class CanvasRenderer extends Renderer {
    ...
    async renderTextNode(text, styles, containerBounds) {
        ...
        const shouldApplyLineClamp = styles.webkitLineClamp > 0 && (styles.display & 2 /* DISPLAY.BLOCK */ ) !== 0 && styles.overflowY === 1 /* OVERFLOW.HIDDEN */  && text.textBounds.length > 0;
        ...
        const shouldApplyEllipsis = styles.textOverflow === 1 /* TEXT_OVERFLOW.ELLIPSIS */  && containerBounds && styles.overflowX === 1 /* OVERFLOW.HIDDEN */  && text.textBounds.length > 0;
