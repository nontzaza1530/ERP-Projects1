...
function Sidebar({ isOpen, onClose }) {
    ...
    const handleLinkClick = ()=>{
        // ปิดเมนูเมื่อมีการคลิกลิงก์ในหน้าจอมือถือ
    ...
    // 🔥 Logic กรองเมนู (Filter) ตาม Role
    ...
    // แสดง Sidebar ว่างๆ ระหว่างรอโหลด Role เพื่อกัน Layout ขยับ
...
function ProfilePage() {
    ...
    const [isSidebarOpen, setIsSidebarOpen] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])(false); // State สำหรับเปิด/ปิด Sidebar บนมือถือ
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
    ...
    const getWorkDuration = (dateString_0)=>{
        if (!dateString_0) return '-';
        const start = new Date(dateString_0);
        const now = new Date();
...
_s(ProfilePage, "x130xejp+z7GJjcwrYtjWRPNNu4=");
_c = ProfilePage;
var _c;
...
//# sourceMappingURL=src_7133b1b2._.js.map