...
"[project]/src/app/accounting/page.jsx [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
function AccountingPage() {
    ...
    const prevPage = ()=>currentPage > 1 && setCurrentPage((curr_0)=>curr_0 - 1);
    // --- 4. Submit ---
    const handleSubmit = async (e)=>{
        e.preventDefault();
        if (!formData.amount || !formData.category) {
            __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$sweetalert2$2f$dist$2f$sweetalert2$2e$all$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"].fire('ข้อมูลไม่ครบ', 'กรุณากรอกหมวดหมู่และจำนวนเงิน', 'warning');
            return;
        }
        try {
            const res_0 = await fetch('/api/accounting', {
                method: 'POST',
                headers: {
...
//# sourceMappingURL=src_e1b81a4a._.js.map