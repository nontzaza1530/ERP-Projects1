...
"[project]/src/app/api/production/documents/[Id]/route.js [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
async function DELETE(req, { params }) {
    try {
        ...
        const [rows] = await connection.execute('SELECT file_path FROM project_documents WHERE id = ?', [
            id
        ]);
        if (rows.length > 0) {
            ...
            const absolutePath = __TURBOPACK__imported__module__$5b$externals$5d2f$path__$5b$external$5d$__$28$path$2c$__cjs$29$__["default"].join(process.cwd(), 'public', safePath);
            try {
                await (0, __TURBOPACK__imported__module__$5b$externals$5d2f$fs$2f$promises__$5b$external$5d$__$28$fs$2f$promises$2c$__cjs$29$__["unlink"])(absolutePath); // สั่งลบไฟล์
        ...
        await connection.execute('DELETE FROM project_documents WHERE id = ?', [
            id
        ]);
...
//# sourceMappingURL=%5Broot-of-the-server%5D__d8c0121a._.js.map