...
async function GET(request, { params }) {
    ...
    try {
        ...
        const [invoices] = await connection.execute('SELECT * FROM invoices WHERE id = ?', [
            id
        ]);
        if (invoices.length === 0) return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
            error: 'Invoice not found'
        }, {
            status: 404
        });
        const [items] = await connection.execute('SELECT * FROM invoice_items WHERE invoice_id = ?', [
            id
        ]);
...
//# sourceMappingURL=%5Broot-of-the-server%5D__1704ba98._.js.map