...
"[project]/src/app/api/dashboard/stats/route.js [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$app$2f$lib$2f$db$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/src/app/lib/db.js [app-route] (ecmascript)"); // ⚠️ เช็ค Path ให้ตรงกับโปรเจกต์คุณ
;
;
async function GET() {
    try {
        // 1. นับจำนวนใบลาที่สถานะเป็น 'pending' (รออนุมัติ)
        const [pendingRows] = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$app$2f$lib$2f$db$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"].query("SELECT COUNT(*) as count FROM leave_requests WHERE status = 'pending'");
        ...
        const [whoIsAway] = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$app$2f$lib$2f$db$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"].query(`
...
//# sourceMappingURL=%5Broot-of-the-server%5D__17f25de5._.js.map