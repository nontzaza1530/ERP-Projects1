...
"[project]/src/app/api/sales/receipt/[id]/route.js [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$app$2f$lib$2f$db$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/src/app/lib/db.js [app-route] (ecmascript)"); // 👈 เช็ค path ../ ให้ตรงกับตำแหน่งไฟล์ db.js ของคุณ
;
;
async function GET(request, { params }) {
    ...
    try {
        // 1. ดึงหัวบิล (Orders)
        const [orders] = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$app$2f$lib$2f$db$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"].query(`SELECT * FROM orders WHERE id = ?`, [
            id
        ]);
        if (orders.length === 0) {
        ...
        const [items] = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$app$2f$lib$2f$db$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"].query(`SELECT * FROM order_items WHERE order_id = ?`, [
            id
        ]);
        return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
            order: orders[0],
...
//# sourceMappingURL=%5Broot-of-the-server%5D__aeae0176._.js.map