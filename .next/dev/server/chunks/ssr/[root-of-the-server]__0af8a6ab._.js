...
"[project]/src/app/purchasing/po-list/page.jsx [app-ssr] (ecmascript)", ((__turbopack_context__) => {
"use strict";
    ...
    const handleCancelPO = async (po)=>{
        ...
        if (result.isConfirmed) {
            try {
                ...
                if (res.ok) {
                    await __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$sweetalert2$2f$dist$2f$sweetalert2$2e$esm$2e$all$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["default"].fire('สำเร็จ', 'ใบสั่งซื้อถูกยกเลิกแล้ว', 'success');
                    fetchPO();
                } else {
                    const data = await res.json();
                    __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$sweetalert2$2f$dist$2f$sweetalert2$2e$esm$2e$all$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["default"].fire('แจ้งเตือน', data.error, 'error');
                }
            } catch (err) {
...
//# sourceMappingURL=%5Broot-of-the-server%5D__0af8a6ab._.js.map