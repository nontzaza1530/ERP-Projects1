...
"[project]/src/app/accounting/project-quotations/edit/[id]/page.jsx [app-ssr] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
function EditQuotationPage() {
    ...
    const fetchQuotation = async ()=>{
        try {
            ...
            if (res.ok) {
                ...
                __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$sweetalert2$2f$dist$2f$sweetalert2$2e$esm$2e$all$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["default"].fire('Error', 'ไม่พบข้อมูลใบเสนอราคา', 'error');
    ...
    const handleSubmit = async ()=>{
        ...
        if (isInvalid) return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$sweetalert2$2f$dist$2f$sweetalert2$2e$esm$2e$all$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["default"].fire('แจ้งเตือน', 'กรุณากรอกรายละเอียดและจำนวนให้ครบถ้วน', 'warning');
        setIsLoading(true);
        try {
            const payload = {
                ...formData,
    ...
    if (isDataLoading) return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
...
//# sourceMappingURL=%5Broot-of-the-server%5D__fb82d684._.js.map