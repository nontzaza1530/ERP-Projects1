...
"[project]/src/app/api/purchasing/po/create/route.js [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$app$2f$lib$2f$db$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/src/app/lib/db.js [app-route] (ecmascript)"); // ปรับ path ตามจริง
;
;
async function POST(request) {
    ...
    try {
        ...
        const [lastPo] = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$app$2f$lib$2f$db$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"].query(`SELECT po_number FROM purchase_orders WHERE po_number LIKE 'PO-${datePart}-%' ORDER BY id DESC LIMIT 1`);
        let runNumber = 1;
        if (lastPo.length > 0) {
        ...
        const [resHeader] = await connection.query(`INSERT INTO purchase_orders (po_number, supplier_id, order_date, expected_date, total_amount, created_by, status, remarks) 
         VALUES (?, ?, ?, ?, ?, ?, 'Pending', ?)`, [
            poNumber,
            supplier_id,
            order_date,
...
//# sourceMappingURL=%5Broot-of-the-server%5D__8ad12ab2._.js.map