...
"[project]/src/app/api/production/projects/[id]/documents/route.js [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
async function POST(req) {
    try {
        ...
        // 1. จัดการบันทึกไฟล์ลงโฟลเดอร์ public/uploads
        ...
        await connection.execute('INSERT INTO project_documents (project_id, file_name, file_path, file_type, uploaded_by) VALUES (?, ?, ?, ?, ?)', [
            projectId,
            file.name,
            `/uploads/${filename}`,
            file.type,
...
//# sourceMappingURL=%5Broot-of-the-server%5D__67aa38df._.js.map