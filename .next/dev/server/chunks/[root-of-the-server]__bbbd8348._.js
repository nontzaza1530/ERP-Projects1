...
"[project]/src/app/api/purchasing/pr/[id]/route.js [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
async function GET(request, { params }) {
    ...
    try {
        ...
        const [prHeaders] = await connection.query(`SELECT pr.*, e.first_name, e.last_name FROM purchase_requests pr LEFT JOIN employees e ON pr.requester_id = e.emp_code WHERE pr.id = ?`, [
            id
        ]);
        if (prHeaders.length === 0) return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
            error: "ไม่พบข้อมูลใบขอซื้อ"
        }, {
            status: 404
        });
        const [prItems] = await connection.query(`SELECT pri.*, p.name as product_name, p.product_code FROM purchase_request_items pri LEFT JOIN products p ON pri.product_id = p.id WHERE pri.pr_id = ?`, [
            id
        ]);
...
async function PUT(request, { params }) {
    ...
    try {
        ...
        await connection.query(`UPDATE purchase_requests SET request_date=?, remarks=?, project_name=?, suggested_vendor=?, vendor_contact=?, required_date=? WHERE id=?`, [
            request_date,
            remarks || null,
            project_name || null,
        ...
        await connection.query(`DELETE FROM purchase_request_items WHERE pr_id = ?`, [
            id
        ]);
...
async function DELETE(request, { params }) {
    try {
        const { id } = await params;
        await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$app$2f$lib$2f$db$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"].query(`DELETE FROM purchase_request_items WHERE pr_id = ?`, [
            id
        ]);
        await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$app$2f$lib$2f$db$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"].query(`DELETE FROM purchase_requests WHERE id = ?`, [
            id
        ]);
        return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
            success: true,
...
//# sourceMappingURL=%5Broot-of-the-server%5D__bbbd8348._.js.map