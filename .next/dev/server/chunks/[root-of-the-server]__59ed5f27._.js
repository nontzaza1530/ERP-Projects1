...
"[project]/src/app/api/sales/quotation/route.js [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$app$2f$lib$2f$db$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/src/app/lib/db.js [app-route] (ecmascript)"); // ✅ เช็ค Path ให้ถูกต้องตามโครงสร้างโปรเจคคุณ
;
;
;
;
async function POST(request) {
    ...
    try {
        ...
        const [headerResult] = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$app$2f$lib$2f$db$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"].query(`INSERT INTO quotations (
          quotation_no, 
          customer_name, 
          customer_phone, 
          customer_address, 
       ...
       VALUES (?, ?, ?, ?, ?, ?)`, [
        ...
        for (const item of cart){
            await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$app$2f$lib$2f$db$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"].query(`INSERT INTO quotation_items (quotation_id, product_id, product_name, price, quantity, total) 
         VALUES (?, ?, ?, ?, ?, ?)`, [
                quotationId,
                item.id,
                item.name,
...
//# sourceMappingURL=%5Broot-of-the-server%5D__59ed5f27._.js.map