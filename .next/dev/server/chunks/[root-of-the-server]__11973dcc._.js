...
async function GET() {
    try {
        // 1. Employee Count
        const [empResult] = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$app$2f$lib$2f$db$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"].query('SELECT COUNT(*) as count FROM employees');
        const employeeCount = empResult[0].count;
        // 2. Low Stock Count (Items with quantity <= min_level)
        const [stockResult] = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$app$2f$lib$2f$db$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"].query('SELECT COUNT(*) as count FROM products WHERE quantity <= min_level');
        const stockAlert = stockResult[0].count;
        // 3. Today's Sales
        // Assuming 'orders' table has a 'sale_date' or similar timestamp column
        const today = new Date().toISOString().slice(0, 10); // YYYY-MM-DD
        const [salesResult] = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$app$2f$lib$2f$db$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"].query('SELECT SUM(total_amount) as total FROM orders WHERE DATE(sale_date) = ?', [
            today
        ]);
        ...
        const [recentOrders] = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$app$2f$lib$2f$db$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"].query(`
      SELECT 
        id, 
        customer_name, 
        total_amount, 
    ...
    `);
        ...
        const recentActivities = recentOrders.map((order)=>({
                ...
                desc: `โดย ${order.customer_name || 'ลูกค้าทั่วไป'}`,
                amount: order.total_amount,
                time: new Date(order.sale_date).toLocaleTimeString('th-TH', {
                    hour: '2-digit',
                    minute: '2-digit'
                }),
                type: 'sale'
...
//# sourceMappingURL=%5Broot-of-the-server%5D__11973dcc._.js.map