...
async function POST(request) {
    ...
    try {
        ...
        const [orderResult] = await connection.query('INSERT INTO orders (customer_name, customer_phone, customer_address, total_amount, payment_method) VALUES (?, ?, ?, ?, ?)', [
        ...
        for (const item of cart){
            ...
            const [productCheck] = await connection.query('SELECT quantity FROM products WHERE id = ? FOR UPDATE', [
                item.id
            ]);
            ...
            await connection.query('INSERT INTO order_items (order_id, product_id, product_name, quantity, price_per_unit) VALUES (?, ?, ?, ?, ?)', [
                orderId,
                item.id,
                item.name,
                item.qty,
...
//# sourceMappingURL=%5Broot-of-the-server%5D__e92d1095._.js.map